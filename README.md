...
- SpecTre: A Tiny Side-Channel Resistant Speck Core for FPGAs, published @ CARDIS 2016, Proceedings of the Smart Card Research and Advanced Application Conference

- Cache Attacks Enable Bulk Key Recovery on the Cloud, published @ CHES 2016, Conference on Cryptographic Hardware and Embedded Systems
 
- Cross-VM Cache Attacks on AES, published @ IEEE Transactions on Multi-Scale Computing Systems
...
- A Faster and More Realistic Flush+Reload Attack on AES, published @ COSADE 2015, 6th International Workshop on Constructive Side-Channel Analysis and Secure Design

- Know Thy Neighbor: Crypto Library Detection in Cloud, published @ PETS 2015, Proceedings on Privacy Enhancing Technologies
